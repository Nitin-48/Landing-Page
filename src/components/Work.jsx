...
export default function Work() {
  ...
  const getTransform = (i) => {
    if (isMobile) {
      if (phase === 0) return i === 0 ? "translateY(0)" : "translateY(150%)";
      if (phase === 1) {
        if (i === 0) return "translateY(-80px)";
        if (i === 1) return "translateY(80px)";
        return "translateY(300%)";
      }
      if (phase === 2) {
        if (i === 0) return "translateY(-150px)";
        if (i === 1) return "translateY(-10px)";
        if (i === 2) return "translateY(140px)";
      }
